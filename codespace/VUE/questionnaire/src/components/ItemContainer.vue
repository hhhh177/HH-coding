<template>
    <section>
        <header class="top_tips">
            <spen class="num_tip"  v-if="parentComponent === 'home'">第一周</spen>
            <spen class="num_tip"  v-if="parentComponent === 'item'">题目一</spen>
        </header>
                ...
                <div class="item_list_container">
                    ...
                    <ul>
                        <li class="item_list"  v-for="(item , index) in questions[0].answers">
                            <span class="option_style">{{chhoseType(index)}}</span>
...
<script>
    export default {
        ...
        data(){
            return{
                questions:[
                    {id: 1, titel: '题目一' , answers: ['答案一','答案二','答案三','答案四'] },
                    {id: 2, titel: '题目二' , answers: ['答案一','答案二','答案三','答案四'] },
                    {id: 3, titel: '题目三' , answers: ['答案一','答案二','答案三','答案四'] },
                    {id: 4, titel: '题目四' , answers: ['答案一','答案二','答案三','答案四'] },
                    {id: 5, titel: '题目五' , answers: ['答案一','答案二','答案三','答案四'] },
                ]
            }
        },
        methods:{
